    ...
    <div className="vysiongids-job-modal-root" role="presentation">
      ...
      >
        ...
        <p className="vysiongids-job-modal-zaak">
          <Link href={`/zaak/${listing.slug}#vacature`} className="vysiongids-job-card-zaak-link" onClick={onClose}>
            {listing.name}
          </Link>
        ...
        {description ? (
          ...
          <p className="vysiongids-job-modal-text vysiongids-job-modal-text--muted">
            Geen extra omschrijving. Neem contact op via e-mail of telefoon.
          </p>
        )}
        {mailHref || telHref ? (
