  ...
  return (
    <>
      <p style={{ margin: '0 0 1.25rem', maxWidth: '40rem', color: '#4b5563', lineHeight: 1.6 }}>
        Klein advertentiebord voor horeca: materiaal te koop, ruil, hulp gezocht, … Premium-leden plaatsen via de
        popup hieronder.
      </p>
      ...
      {!loading && !loadError && zoekertjes.length === 0 ? (
        <p className="vysiongids-jobs-empty">Nog geen zoekertjes — wees de eerste.</p>
      ) : null}
